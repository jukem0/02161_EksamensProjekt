...
// public void at_medarbejder_er_projektleder_under(String medarbejder, String
// projektnavn) {
// throw new io.cucumber.java.PendingException();
// }

// @When("{string} bestemmer start- og sluttid til {string} som datoer {string},
// {string}")
// public void medarbejder_bestemmer_start_og_sluttid(String medarbejder, String
// aktivitet, String startdato,
// String slutdato) {
// throw new io.cucumber.java.PendingException();
// }

// @Then("tildel {string} datoerne, {string} og {string} som værende afgrænsede
// tid for færdiggørelse af projekt")
// public void tildel_datoer(String aktivitet, String startdato, String
// slutdato) {
// throw new io.cucumber.java.PendingException();
// }
...
// @When("{string} bestemmer budgetteret tid til {string} som positivt
// decimaltal eller heltal")
// public void bestemmer_budgetteret_tid(String medarbejder, String aktivitet) {
// throw new io.cucumber.java.PendingException();
// }

// @Then("tildel {string} mængde af budgetteret tid rundet op til nærmeste
// halve")
// public void tildel_budgetteret_tid(String aktivitet) {
// throw new io.cucumber.java.PendingException();
// }

// @When("{string} bestemmer budgetteret tid, {string}, til {string} som andet
// end decimal- eller heltal")
// public void bestemmer_budgetteret_tid_forkert(String medarbejder, String
// budget, String aktivitet) {
// throw new io.cucumber.java.PendingException();
// }

// // opretaktivitet.feature steps - færdiggjort i aktivitetstepdefinitions.java

// // registreretid.feature steps - færdiggjort

// // tildelmedarbejder.feature steps
// @When("en medarbejder {string} udpeger en anden medarbejder {string} til at
// lave aktivitet med {string}")
// public void medarbejder_udpeger_anden(String medarbejder1, String
// medarbejder2, String aktivitet) {
// throw new io.cucumber.java.PendingException();
// }

// @Then("tildel medarbejder {string} til aktivitet med navn {string} skal
// lykkes")
// public void tildel_medarbejder_til_aktivitet_skal_lykkes(String medarbejder,
// String aktivitet) {
// throw new io.cucumber.java.PendingException();
// }

// @When("en anden medarbjeder udpeger {string} til at lave aktivitet med
// {string}")
