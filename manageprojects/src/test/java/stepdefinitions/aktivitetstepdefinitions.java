...
// en given liste af medarbejdere for at vise hvem er i systemet.
// System.out.println("Følgende medarbejdere findes i systemet:" +
// table.asList());
// // Liste er allerede initialiseret med systemets medarbejdere; denne step er
// kun til reference.
// }

// @Given("en {string} findes i systemet")
// public void getmedarbejder(String medarbejder) {
// assert Main.findMedarbejder(medarbejder) : "Medarbejder " + medarbejder + "
// findes ikke i systemet.";
...
// "Medarbejder " + aktuelMedarbejder + " er hverken projektleder eller ledig
// for projektet " + valgtProjekt;
...
// assert (oprettedeAktiviteter.stream().noneMatch(a ->
// a.getNavn().equals(aktivitetsnavn))):
// "Aktivitet " + aktivitetsnavn + " findes allerede i projektet " +
// valgtProjekt;
...
// assert Main.projekter.stream().anyMatch(p ->
// p.getProjektNavn().equals(valgtProjekt)) : "Projekt " + valgtProjekt + "
// findes ikke i systemet.";
// }

// @And("der findes allerede en aktivitet med navn {string}")
// public void geteksisterendeAktivitet(String aktivitetsnavn) {
// assert (oprettedeAktiviteter.stream().anyMatch(a ->
// a.getNavn().equals(aktivitetsnavn))) :
...
// assert opretFejlbesked != null : "Der var ingen fejl ved oprettelse af
// aktivitet, men der blev forventet en.";
// assert opretFejlbesked.equals(fejlbesked) : "Forventet fejlbesked '" +
// fejlbesked + "', men fik '" + opretFejlbesked + "'.";
// }
