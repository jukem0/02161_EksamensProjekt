...
// // if (medarbejder.exists()) { //I know this sounds cooked but don't know how
// to write it well without the actual implementation of the Medarbejder class
// // System.out.println("Medarbejder " + medarbejder + " findes i systemet.");
// // } else {
// // System.out.println("Medarbejder " + medarbejder + " findes ikke i
// systemet.");
// // }
// // }
...
// ProjektRapport projektRapport = new ProjektRapport(projektNavn +
// "-rapport-uge-" + ugenummer);
// assertTrue(projektRapport.getName().equalsIgnoreCase(projektNavn +
// "-rapport-uge-" + ugenummer));
// }
